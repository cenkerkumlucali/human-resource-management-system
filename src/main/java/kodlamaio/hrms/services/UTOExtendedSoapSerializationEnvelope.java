...
public class UTOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UTODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UTOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UTODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UTODateTimeConverter dateTimeConverter = new UTOStandardDateTimeConverter();

    public UTOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UTOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UTOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UTOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UTOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UTOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
