...
public class UTOKPSPublicSoap
{
    ...
    public UTOKPSPublicSoap(){}

    public UTOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UTOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UTOExtendedSoapSerializationEnvelope envelope= new UTOExtendedSoapSerializationEnvelope(UTOExtendedSoapSerializationEnvelope.VER11);
